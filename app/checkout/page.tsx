...
import ShoppingCart from "@/components/shopping-cart" // Declared the ShoppingCart variable
        ...
        <main className="flex-1 container mx-auto px-4 py-8 md:py-12 flex items-center justify-center">
          <Card className="max-w-md w-full text-center p-8 shadow-lg">
            <CardContent className="space-y-6">
              ...
              <h2 className="text-3xl font-bold text-gray-900 font-heading">Thank You for Your Order!</h2>
              <p className="text-lg text-gray-700">Your order has been successfully placed.</p>
              <p className="text-gray-600">
                You will receive an email confirmation shortly with your order details and tracking information.
              </p>
              <Link href="/orders">
                <Button className="bg-primary hover:bg-primary-600 text-primary-foreground mt-4">View My Orders</Button>
              </Link>
              <Link href="/products">
                <Button variant="outline" className="mt-2 text-primary hover:bg-primary-50 bg-transparent">
                  Continue Shopping
                </Button>
              </Link>
            </CardContent>
    ...
    <div className="min-h-screen bg-background font-sans">
      ...
      <main className="container mx-auto px-4 py-8 md:py-12">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 font-heading">Checkout</h1>
            ...
            <CardContent>
              <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input id="fullName" value={shippingDetails.fullName} onChange={handleInputChange} required />
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="phone" type="tel" value={shippingDetails.phone} onChange={handleInputChange} required />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input id="city" value={shippingDetails.city} onChange={handleInputChange} required />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="zip">Zip/Postal Code</Label>
                  <Input id="zip" value={shippingDetails.zip} onChange={handleInputChange} />
                </div>
                <div className="space-y-2 md:col-span-2">
                  <Label htmlFor="country">Country</Label>
                  <Input id="country" value={shippingDetails.country} onChange={handleInputChange} disabled />
                </div>
              </form>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col space-y-2">
                  ...
                  <Label htmlFor="payment-mobile-money" className="flex items-center cursor-pointer">
                    <Input
                      type="radio"
